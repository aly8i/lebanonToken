            ...
            <div className={styles.header}>
                <div className={styles.menuCircle}/>
                    <div className={styles.headerMenu}>
                        <a className={`${styles.menuLink} ${styles.a} ${styles.isActive}`} href="#">Apps</a>
                        <a className={`${styles.menuLink} ${styles.a} ${styles.notify}`} href="#">Your work</a>
                        <a className={`${styles.menuLink} ${styles.a}`} href="#">Discover</a>
                        <a className={`${styles.menuLink} ${styles.a} ${styles.notify}`} href="#">Market</a>
                    </div>
                    ...
                    <div className={styles.headerProfile}>
                        ...
                        <svg viewBox="0 0 512 512" fill="currentColor" className={styles.svg}>
                ...
                <div className={styles.wrapper}>
                    <div className={styles.leftSide}>
                        <div className={styles.sideWrapper}>
                            <div className={styles.sideTitle}>Apps</div>
                                <div className={styles.sideMenu}>
                                    ...
                                    <a href="#" className={styles.a}>
                                        <svg viewBox="0 0 488.932 488.932" fill="currentColor" className={styles.svg}>
                                            <path d="M243.158 61.361v-57.6c0-3.2 4-4.9 6.7-2.9l118.4 87c2 1.5 2 4.4 0 5.9l-118.4 87c-2.7 2-6.7.2-6.7-2.9v-57.5c-87.8 1.4-158.1 76-152.1 165.4 5.1 76.8 67.7 139.1 144.5 144 81.4 5.2 150.6-53 163-129.9 2.3-14.3 14.7-24.7 29.2-24.7 17.9 0 31.8 15.9 29 33.5-17.4 109.7-118.5 192-235.7 178.9-98-11-176.7-89.4-187.8-187.4-14.7-128.2 84.9-237.4 209.9-238.8z" />
                                        </svg>
                                        Updates
                                        <span className={`${styles.notificationNumber} ${styles.span} ${styles.updates}`}>3</span>
                                    </a>
                                </div>
                            </div>
                            <div className={styles.sideWrapper}>
                                <div className={styles.sideTitle}>Categories</div>
                                    <div className={styles.sideMenu}>
                                        <a href="#" className={styles.a}>
                                            <svg viewBox="0 0 488.455 488.455" fill="currentColor" className={styles.svg}>
                                        ...
                                        <a href="#" className={styles.a}>
                                            <svg viewBox="0 0 512 512" fill="currentColor" className={styles.svg}>
                                                <circle cx="295.099" cy="327.254" r="110.96" transform="rotate(-45 295.062 327.332)" className={styles.circle}/>
                                        ...
                                        <a href="#" className={styles.a}>
                                            <svg viewBox="0 0 58 58" fill="currentColor" className={styles.svg}>
                                ...
                                <div className={styles.sideWrapper}>
                                    <div className={styles.sideTitle}>Fonts</div>
                                        <div className={styles.sideMenu}>
                                            <a href="#" className={styles.a}>
                                                <svg viewBox="0 0 332 332" fill="currentColor" className={styles.svg}>
                                    ...
                                    <div className={styles.sideWrapper}>
                                        <div className={styles.sideTitle}>Resource Links</div>
                                            <div className={styles.sideMenu}>
                                                <a href="#" className={styles.a}>
                                                    <svg viewBox="0 0 512 512" fill="currentColor" className={styles.svg}>
                                                ...
                                                <a href="#" className={styles.a}>
                                                    <svg viewBox="0 0 511.441 511.441" fill="currentColor" className={styles.svg}>
                                        ...
                                        <div className={styles.contentWrapperHeader}>
                                            <div className={styles.contentWrapperContext}>
                                                <h3 className={styles.imgContent}>
                                                    <svg viewBox="0 0 512 512" className={`${styles.headerMenu} ${styles.svg}`}>
                                            ...
                                            <div className={styles.contentSection}>
                                                <div className={styles.contentSectionTitle}>Installed</div>
                                                    <ul className={styles.ul}>
                                                        <li className={`${styles.adobeProduct} ${styles.li}`}>
                                                            <div className={styles.products}>
                                                                <svg viewBox="0 0 52 52" className={styles.svg} style={{border:"1px solid #3291b8"}}>
                                                            ...
                                                            <span className={`${styles.status} ${styles.span}`}>
                                                                <span className={`${styles.statusCircle}  ${styles.span} ${styles.green}`}></span>
                                                            Updated
                                                            </span>
                                                            <div className={styles.buttonWrapper}>
                                                                <button className={`${styles.contentButton} ${styles.button} ${styles.statusButton} ${styles.open}`}>Open</button>
                                                                <div className={styles.menu}>
                                                                    <button className={`${styles.dropdown} ${styles.button}`}>
                                                                        <ul className={styles.ul}>
                                                                            <li><a href="#" className={`${styles.li} ${styles.a}`}>Go to Discover</a></li>
                                                                            <li><a href="#" className={`${styles.li} ${styles.a}`}>Learn more</a></li>
                                                                            <li><a href="#" className={`${styles.li} ${styles.a}`}>Uninstall</a></li>
                                                                        </ul>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li className={`${styles.li} ${styles.adobeProduct}`}>
                                                        <div className={styles.products}>
                                                            <svg viewBox="0 0 52 52" className={styles.svg} style={{border:"1px solid #b65a0b"}}>
                                                                <g xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <span className={`${styles.status} ${styles.span}`}>
                                                            <span className={`${styles.statusCircle} ${styles.span}`}></span>
                                                        Update Available
                                                        </span>
                                                        <div className={styles.buttonWrapper}>
                                                            <button className={`${styles.contentButton} ${styles.button} ${styles.statusButton}`}>Update this app</button>
                                                            <div className={styles.popUp}>
                                                                <div className={styles.popUpTitle}>Update This App
                                                                    <svg className={`${styles.close} ${styles.feather} ${styles.svg} ${styles.featherXCircle}`} width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                                        <circle cx="12" cy="12" r="10" className={styles.circle}/>
                                                                        <path d="M15 9l-6 6M9 9l6 6" />
                                                                    </svg>
                                                                </div>
                                                                <div className={styles.popUpSubtitle}>Adjust your selections for advanced options as desired before continuing. <a href="#">Learn more</a></div>
                                                                <div className={styles.checkboxWrapper}>
                                                                    <input type="checkbox" id="check1" className={`${styles.checkbox} ${styles.input}`}/>
                                                                    <label for="check1" className={styles.label}>Import previous settings and preferences</label>
                                                                </div>
                                                                <div className={styles.checkboxWrapper}>
                                                                    <input type="checkbox" id="check2" className={`${styles.checkbox} ${styles.input}`}/>
                                                                    <label for="check2" className={styles.label}>Remove old versions</label>
                                                                </div>
                                                                <div className={styles.contentButtonWrapper}>
                                                                    <button className={`${styles.contentButton} ${styles.button} ${styles.statusButton} ${styles.open} ${styles.close}`}>Cancel</button>
                                                                    <button className={`${styles.contentButton} ${styles.button} ${styles.statusButton}`}>Continue</button>
                                                                </div>
                                                            </div>
                                                            <div className={styles.menu}>
                                                                <button className={`${styles.dropdown} ${styles.button}`}>
                                                                    <ul className={styles.ul}>
                                                                        <li className={styles.li}><a href="#" className={styles.a}>Go to Discover</a></li>
                                                                        <li className={styles.li}><a href="#" className={styles.a}>Learn more</a></li>
                                                                        <li className={styles.li}><a href="#" className={styles.a}>Uninstall</a></li>
                                                                    </ul>
                                                                </button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li className={`${styles.li} ${styles.adobeProduct}`}>
                                                    <div className={styles.products}>
                                                        <svg viewBox="0 0 52 52" className={styles.svg} style={{border: "1px solid #C75DEB"}}>
                                                            <g xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div className={styles.buttonWrapper}>
                                                        <button className={`${styles.contentButton} ${styles.button} ${styles.statusButton} ${styles.open}`}>Open</button>
                                                        <div className={styles.menu}>
                                                            <button className={`${styles.button} ${styles.dropdown}`}>
                                                                <ul className={styles.ul}>
                                                                    <li className={styles.li}><a className={styles.a}href="#">Go to Discover</a></li>
                                                                    <li className={styles.li}><a href="#" className={styles.a}>Learn more</a></li>
                                                                    <li className={styles.li}><a href="#" className={styles.a}>Uninstall</a></li>
                                                                </ul>
                                                            </button>
                        ...
                        <div className={styles.contentSection}>
                            <div className={styles.contentSectionTitle}>Apps in your plan</div>
                            <div className={styles.appsCard}>
                                <div className={styles.appCard}>
                                    <span>
                                        <svg viewBox="0 0 512 512" className={styles.svg} style={{border: "1px solid #a059a9"}}>
                                    ...
                                    <div className={styles.appCardSubtext}>Edit, master and create fully proffesional videos</div>
                                    <div className={styles.appCardButtons}>
                                        <button className={`${styles.contentButton} ${styles.button} ${styles.statusButton}`}>Update</button>
                                        <div className={styles.menu}></div>
                                    </div>
                                </div>
                                <div className={styles.appCard}>
                                    <span>
                                        <svg viewBox="0 0 52 52" className={styles.svg} style={{border: "1px solid #c1316d"}}>
                                            <g xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className={styles.appCardSubtext}>Design and publish great projects & mockups</div>
                                    <div className={styles.appCardButtons}>
                                        <button className={`${styles.contentButton} ${styles.button} ${styles.statusButton}`}>Update</button>
                                        <div className={styles.menu}></div>
                                    </div>
                                ...
                                <div className={styles.appCard}>
                                    ...
                                    <div className={styles.appCardSubtext}>Industry Standart motion graphics & visual effects</div>
                                    <div className={styles.appCardButtons}>
                                        <button className={`${styles.contentButton} ${styles.button} ${styles.statusButton}`}>Update</button>
                                        <div className={styles.menu}></div>
                                    </div>
